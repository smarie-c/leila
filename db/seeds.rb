...
Contact.create(:texte1 => "french example 1", :texte1en => "en example 1")
...
Index.create(:texte1 => "laila",:texte2 => "EL HALFI",:texte3 => "36 Avenue Bugeaud,",:texte4 => "75016 paris",:texte5 => "09 65 03 61 65",:texte6 => "Avocats spécialisé en droit du travail,",:texte7 => "droit de la sécurité sociale et droit pénal du travail. Expertise en conseil / contentieux / audit social / restructurations d'entreprises",:texte8 => "french example 1 8",:texte9 => "french example 1 9",:texte10 => "french example 1 10",:texte11 => "french example 1 11",:texte1en => "en example 1 1",:texte2en => "en example 1 2",:texte3en => "en example 1 3",:texte4en => "en example 1 4",:texte5en => "en example 1 5",:texte6en => "en example 1 6",:texte7en => "en example 1 7",:texte8en => "en example 1 8",:texte9en => "en example 1 9",:texte10en => "en example 1 10",:texte11en => "en example 1 11")
